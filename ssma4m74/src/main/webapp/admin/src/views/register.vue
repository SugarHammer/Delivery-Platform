  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
        <h1 class="h1" style="color:#000;fontSize:28px;">微信外卖小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话" type="text" />
												...
												<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">商家邮箱</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shangjiayouxiang" class="input" type="text" placeholder="商家邮箱">
			   </div>
			 </div> -->
			<el-form-item label="商家邮箱" class="input" v-if="tableName=='shangjia'">
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("https://www.2008php.com/2021_Website_appreciate/2021-03-12/202103122117071BTbZ.jpg");
		height: 100vh;
